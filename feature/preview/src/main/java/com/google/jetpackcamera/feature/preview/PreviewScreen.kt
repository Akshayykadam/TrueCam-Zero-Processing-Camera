    ...
    when (val currentUiState = captureUiState) {
        ...
        is CaptureUiState.Ready -> {
            ...
            ContentScreen(
                ...
                onSetExposureCompensation = viewModel::setExposureCompensation,
                onResetFocusAndMetering = viewModel::resetFocusAndMetering,
...
private fun ContentScreen(
    ...
    onTapToFocus: (x: Float, y: Float, width: Float, height: Float) -> Unit = { _, _, _, _ -> },
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        viewfinder = {
            PreviewDisplay(
                ...
                onResetFocusAndMetering = onResetFocusAndMetering,
